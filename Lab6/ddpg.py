...
class ActorNet(nn.Module):
    def __init__(self, state_dim=8, action_dim=2, hidden_dim=(400, 300)):
        ...
        self.actor = nn.Linear(h2, action_dim)
        self.relu = nn.ReLU()
        self.tanh = nn.Tanh()
...
class DDPG:
    ...
    def select_action(self, state, action_space, noise=True):
        ...
        if noise:
            ...
            action = action.clip(action_space.low[0], action_space.high[0])
    ...
    def _update_target_network(target_net, net, tau):
        ...
        for target, behavior in zip(target_net.parameters(), net.parameters()):
            ...
            target.data.add_(tau * behavior.data)
    ...
    for n_episode, seed in enumerate(seeds):
        ...
        while(1):
            ...
            if done:
                ...
                break
        print(f"{n_episode+1}: {total_reward}")
